    ...
    public class UserLoginControlViewModel : BaseViewModel
    {
        ...
        public async Task LoginAsUserCommandAsync(object password)
        {
            ...
            try
            {
                ...
                var loggedInUser = (await LoginHelpers.AttemptLogin(PNumber, (password as IHavePassword).SecurePassword)).ToModel<IUser, UserViewModel>();
                ...
                IoC.CreateInstance<ApplicationViewModel>().CurrentUser = loggedInUser;
