namespace Login
{
    ...
    public class UserFunctions
    {
        ...
        public static async Task<bool> LoanArticle(string PersonalNumber, int ArticleID)
        =>
        await rep.LoanArticle(PersonalNumber, ArticleID);
